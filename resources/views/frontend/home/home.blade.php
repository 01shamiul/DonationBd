        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4 mt-4 mt-lg-0">
                    <div class="icon-box active">
                        <figure class="d-flex justify-content-center">
                            <img src="{{asset('/lib/')}}/images/hands-gray.png" alt="">
                            <img src="{{asset('/lib/')}}/images/hands-white.png" alt="">
                        </figure>
                ...
                <div class="col-12 col-md-6 col-lg-4 mt-4 mt-lg-0">
                    <div class="icon-box">
                        <figure class="d-flex justify-content-center">
                            <img src="{{asset('/lib/')}}/images/donation-gray.png" alt="">
                            <img src="{{asset('/lib/')}}/images/donation-white.png" alt="">
                        </figure>
                ...
                <div class="col-12 col-md-6 col-lg-4 mt-4 mt-lg-0">
                    <div class="icon-box">
                        <figure class="d-flex justify-content-center">
                            <img src="{{asset('/lib/')}}/images/charity-gray.png" alt="">
                            <img src="{{asset('/lib/')}}/images/charity-white.png" alt="">
                        </figure>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-6 mt-4 order-1 order-lg-2">
                    <img src="{{asset('/lib/')}}/images/welcome.jpg" alt="welcome">
                </div><!-- .col -->
            </div><!-- .row -->
        </div><!-- .container -->
    </div><!-- .home-page-icon-boxes -->
                ...
                <div class="col-12 col-lg-6">
                    <div class="upcoming-events">
                        ...
                        <div class="event-wrap d-flex flex-wrap justify-content-between">
                            <figure class="m-0">
                                <img src="{{asset('/lib/')}}/images/event-1.jpg" alt="">
                            </figure>
                        ...
                        <div class="event-wrap d-flex flex-wrap justify-content-between">
                            <figure class="m-0">
                                <img src="{{asset('/lib/')}}/images/event-2.jpg" alt="">
                            </figure>
                        ...
                        <div class="event-wrap d-flex flex-wrap justify-content-between">
                            <figure class="m-0">
                                <img src="{{asset('/lib/')}}/images/event-3.jpg" alt="">
                            </figure>
                ...
                <div class="col-12 col-lg-6">
                    <div class="featured-cause">
                        ...
                        <div class="cause-wrap d-flex flex-wrap justify-content-between">
                            <figure class="m-0">
                                <img src="{{asset('/lib/')}}/images/featured-causes.jpg" alt="">
                            </figure>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="cause-wrap">
                                    <figure class="m-0">
                                        <img src="{{asset('/lib/')}}/images/cause-1.jpg" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="cause-wrap">
                                    <figure class="m-0">
                                        <img src="{{asset('/lib/')}}/images/cause-2.jpg" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="cause-wrap">
                                    <figure class="m-0">
                                        <img src="{{asset('/lib/')}}/images/cause-3.jpg" alt="">
                ...
                <div class="col-12 col-lg-6">
                    <div class="milestones d-flex flex-wrap justify-content-between">
                        <div class="col-12 col-sm-4 mt-5 mt-lg-0">
                            <div class="counter-box">
                                <div class="d-flex justify-content-center align-items-center">
                                    <img src="{{asset('/lib/')}}/images/teamwork.png" alt="">
                                </div>
                        ...
                        <div class="col-12 col-sm-4 mt-5 mt-lg-0">
                            <div class="counter-box">
                                <div class="d-flex justify-content-center align-items-center">
                                    <img src="{{asset('/lib/')}}/images/donation.png" alt="">
                                </div>
                        ...
                        <div class="col-12 col-sm-4 mt-5 mt-lg-0">
                            <div class="counter-box">
                                <div class="d-flex justify-content-center align-items-center">
                                    <img src="{{asset('/lib/')}}/images/dove.png" alt="">
                                </div>
