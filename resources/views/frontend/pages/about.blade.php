...
@section('homeContent')
    ...
    <div class="page-header" style=" background: url({{asset('/lib/')}}/images/about-bg.jpg) no-repeat center !important;">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1>About Us</h1>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-5">
                    <div class="testimonial-cont">
                        ...
                        <div class="entry-footer d-flex flex-wrap align-items-center mt-5">
                            <img src="{{asset('/lib/')}}/images/testimonial-1.jpg" alt="">
                ...
                <div class="col-12 col-md-6 offset-lg-2 col-lg-5">
                    <div class="testimonial-cont">
                        ...
                        <div class="entry-footer d-flex flex-wrap align-items-center mt-5">
                            <img src="{{asset('/lib/')}}/images/testimonial-2.jpg" alt="">
