        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="cause-wrap d-flex flex-wrap justify-content-between">
                        <figure class="m-0">
                            <img src="{{asset('/lib/')}}/images/eye-for.jpg" alt="">
                        </figure>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-5 order-1 order-lg-2">
                    <img src="{{asset('/lib/')}}/images/oshomah.jpg" alt="">
                </div><!-- .col -->
            </div><!-- .row -->
        </div><!-- .container -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="cause-wrap">
                        <figure class="m-0">
                            <img src="{{asset('/lib/')}}/images/cause-4.jpg" alt="">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="cause-wrap">
                        <figure class="m-0">
                            <img src="{{asset('/lib/')}}/images/cause-5.jpg" alt="">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="cause-wrap">
                        <figure class="m-0">
                            <img src="{{asset('/lib/')}}/images/cause-6.jpg" alt="">
