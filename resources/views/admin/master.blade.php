            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('/project')}}" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Project</span></a></li>
  <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('/donar-list')}}" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">
@php
$countdonar=App\Donar::where('status',false)->count();
@endphp

  donar 

@if($countdonar > 0)
<b style="color: red">({{$countdonar}})</b>
@else
<b>(0)</b>
@endif
...
<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('/completed-donar')}}" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">
</span>Completed donar</a></li>
